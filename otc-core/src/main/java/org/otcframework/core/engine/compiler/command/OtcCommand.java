...
import org.otcframework.core.engine.compiler.templates.AddMapKeyTemplate;
import org.otcframework.core.engine.compiler.templates.AddMapValueTemplate;
import org.otcframework.core.engine.compiler.templates.AddToCollectionTemplate;
import org.otcframework.core.engine.compiler.templates.ClassBeginTemplate;
import org.otcframework.core.engine.compiler.templates.ExecuteConverterTemplate;
import org.otcframework.core.engine.compiler.templates.ExecuteFactoryMethodCallTemplate;
import org.otcframework.core.engine.compiler.templates.ExecuteModuleTemplate;
import org.otcframework.core.engine.compiler.templates.ForLoopTemplate;
import org.otcframework.core.engine.compiler.templates.GetSetTemplate;
import org.otcframework.core.engine.compiler.templates.GetterIfNullCreateSetTemplate;
import org.otcframework.core.engine.compiler.templates.GetterIfNullReturnTemplate;
import org.otcframework.core.engine.compiler.templates.IfNullContinueTemplate;
import org.otcframework.core.engine.compiler.templates.MethodEndTemplate;
import org.otcframework.core.engine.compiler.templates.PcdInitTemplate;
import org.otcframework.core.engine.compiler.templates.PreloopVarsTemplate;
import org.otcframework.core.engine.compiler.templates.RetrieveMemberFromPcdTemplate;
import org.otcframework.core.engine.compiler.templates.SetterTemplate;
...
public class OtcCommand {
	 ...
	 * @param logLevel the log level
	 */
	public void appendInit(TargetOtcCommandContext targetOCC, SourceOtcCommandContext sourceOCC, boolean createNewVarName, 
			LogLevel logLevel) {
	 ...
	 * @param logLevel the log level
	 */
	public void appendAddMapValue(TargetOtcCommandContext targetOCC, SourceOtcCommandContext sourceOCC, String value, Integer idx,
			LogLevel logLevel) {
	...
	public void appendGetter(TargetOtcCommandContext targetOCC, OtcCommandDto otcCommandDto, boolean createNewVarName) {
		String getter = GetterIfNullReturnTemplate.generateCode(targetOCC, otcCommandDto, createNewVarName, varNamesSet, varNamesMap);
