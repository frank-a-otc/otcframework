...
public abstract class AbstractTemplate {
	...
	protected static final String mainClassBeginCodeTemplate = 
			"// This file was generated by the OTC Engine. \r\n"
			...
			+ "//\r\n"
			+ "\npackage %s;\n"
			+ "\nimport org.otc.common.engine.indexer.dto.IndexedCollectionsDto;"
			+ "\nimport org.otc.common.executor.CodeExecutor;"
			+ "\nimport java.util.Map;"
			+ "\nimport java.util.HashMap;"
	...
	protected static final String factoryModuleClassBeginCodeTemplate = 
			...
			+ "\npackage %s;\n"
			+ "\nimport org.otc.common.engine.indexer.dto.IndexedCollectionsDto;"
			+ "\nimport org.otc.core.engine.module.AbstractOtcModuleExecutor;"
			+ "\n" + OtcCommand.CODE_TO_IMPORT
			...
			if ((otcCommandDto.isCollectionOrMap() && !otcCommandDto.isArray())) {
				...
				if (otcCommandDto.isMap()) {
					...
					if (memberOCD.isMapKey()) {
						genericKey = generics;
						OtcCommandDto valueOCD = otcCommandDto.children.get(OtcConstants.MAP_VALUE_REF + 
								otcCommandDto.fieldName);
						...
						genericVal = generics;
						OtcCommandDto keyOCD = otcCommandDto.children.get(OtcConstants.MAP_KEY_REF + 
								otcCommandDto.fieldName);
	 ...
	 * @return the string
	 */
	protected static String createVarName(OtcCommandDto otcCommandDto, boolean createNewVarName, Set<String> varNamesSet,
